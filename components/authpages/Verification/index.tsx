...
import { ActiveAccount, SendActiviationCode } from "../../../Services";
...
const VerificationForm = ({ t, lang }: any) => {
  ...
  const Submit = (values: any) => {
    ...
    ActiveAccount(email, values.otp, lang)
      .then((res) => {
  ...
  const Resend = () => {
    SendActiviationCode(email, lang)
      .then((res) => {
        countdown(1, 0);
        notifications.show({
          title: "Active Success",
