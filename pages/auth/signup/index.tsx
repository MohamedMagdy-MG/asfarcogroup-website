...
import { GetNationalityData } from "../../../Services";
import { useMediaQuery } from "@mantine/hooks";
type Props = { messages: any; nationalityData: any; lang: any };

const SignupPage = (props: Props) => {
  const t = useTranslations("Signup");
  const { nationalityData, lang } = props;
    ...
    <Container size="xl" pt={rem(120)}>
      <Grid gutter={rem(80)} pt={0} pb={0}>
        <Grid.Col span={matches ? 12 : 6}>
          <SignupForm t={t} nationalityData={nationalityData} lang={lang} />
        </Grid.Col>
        {!matches && (
          <Grid.Col span={6}>
            <Image
